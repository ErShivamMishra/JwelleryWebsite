      ...
      shop.innerHTML="";
        ...
        <div class="item product wd-hover-icons p-0"  onmouseover="btn(p${x.pid},pr${x.pid})" onmouseout="btnq(p${x.pid},pr${x.pid})" >
                ...
                <span id="pri${x.pid}" style="display: none;">${x.pid}</span>
                    <div class="">
                        <div class="">
                            <a id="btn1" style=""  title=\"Add To Cart\" class="btn1" onclick="addCart(pri${x.pid}.innerText)"><i class="bi bi-cart"style="margin-right:20px;"></i></a>
                            <a id="btn" style="" title=\"Read More\" class="btn1" onclick="popUp(pri${x.pid}.innerText)" data-bs-toggle="modal" data-bs-target="#exampleModal" titlt="Quick View"><i class="bi bi-search" style="margin-right:10px;"></i></a>
                        </div>
                    </div>
                </div>
